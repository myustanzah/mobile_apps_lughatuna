...
export default function Footer({onNext, onItemClick, dataDaftarIsi, onNextDisable, onPrevDisable, onPrevious, increaseSize, decreaseSize, playSound}){
    ...
    const triggerModalShow = () => {
        childRef.current.showModalUmrah();
    }
    ...
    return (
            <View style={styles.container}>
                <ModalShow onItemClick={onItemClick} dataDaftarIsi={dataDaftarIsi} ref={childRef} />

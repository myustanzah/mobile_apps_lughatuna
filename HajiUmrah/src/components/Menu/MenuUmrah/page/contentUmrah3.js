...
const folderFile = "03_sai";
const logoUri = API_IMAGES + "01_umrah/" + folderFile + "/sai.png";

const ContentUmrahThree = () => {
...
// API_IMAGES
    ...
    const dataBook = [
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/023.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/023.mp3'}, 
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/024.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/024.mp3'}, 
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/025.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/025.mp3'}, 
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/026.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/026.mp3'},
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/027.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/027.mp3'},
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/028.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/028.mp3'},
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/029.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/029.mp3'},
    ]
...
export default ContentUmrahThree;

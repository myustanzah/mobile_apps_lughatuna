...
const logoUri = API_IMAGES + "01_umrah/" + folderFile + "/tahallul.png";

const ContentUmrahFour = () => {
...
// API_IMAGES
    ...
    const dataBook = [
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/030.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/030.mp3'}, 
        { uri: API_IMAGES + '/01_umrah/'+  folderFile  +'/image/031.png', audio: API_IMAGES + '/01_umrah/'+  folderFile  +'/audio/031.mp3'}, 
...
export default ContentUmrahFour;

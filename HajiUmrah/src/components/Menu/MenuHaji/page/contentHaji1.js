...
const folderFile = "08_tarwiyah"
const logoUri = API_IMAGES + "03_haji/" + folderFile + "/tarwiyah.png";

const ContentHajiOne = () => {
...
// API_IMAGES
    const dataBook = [
        { uri: API_IMAGES + '/03_haji/'+  folderFile  +'/image/034.png', audio: API_IMAGES + '/03_haji/'+  folderFile  +'/audio/034.mp3'}, 
        { uri: API_IMAGES + '/03_haji/'+  folderFile  +'/image/035.png', audio: API_IMAGES + '/03_haji/'+  folderFile  +'/audio/035.mp3'}, 
        { uri: API_IMAGES + '/03_haji/'+  folderFile  +'/image/036.png', audio: API_IMAGES + '/03_haji/'+  folderFile  +'/audio/036.mp3'}, 
        { uri: API_IMAGES + '/03_haji/'+  folderFile  +'/image/037.png', audio: API_IMAGES + '/03_haji/'+  folderFile  +'/audio/037.mp3'},
        { uri: API_IMAGES + '/03_haji/'+  folderFile  +'/image/038.png', audio: API_IMAGES + '/03_haji/'+  folderFile  +'/audio/038.mp3'},
        { uri: API_IMAGES + '/03_haji/'+  folderFile  +'/image/039.png', audio: API_IMAGES + '/03_haji/'+  folderFile  +'/audio/039.mp3'}
    ]
